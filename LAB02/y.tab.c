...
{
       0,    59,    59,    66,    72,    80,    86,    94,    94,   117,
     117,   135,   146,   158,   171,   184,   184,   210,   210,   228,
     245,   253,   261,   271,   288,   306,   323,   344,   351,   360,
     367,   375,   382,   389,   396,   403,   410,   417,   424,   433,
     440,   449,   457,   466,   473,   482,   489,   498,   505,   514,
     522,   531,   539,   549,   556,   563,   572,   579,   586,   593,
     600,   607,   614,   623,   631,   639,   646
};
#endif
...
#line 94 "21201327.y"
    {
			...
			if(!is_function_declared((yyvsp[(2) - (5)])->getname())) {
...
int main(int argc, char *argv[])
{
	...
	yyin = fopen(argv[1], "r");
	outlog.open("21201327_log.txt", ios::trunc);
